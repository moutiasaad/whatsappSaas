...
@section('breadcrumb')
    ...
    <a href="{{ route('super_admin.platform.global-settings') }}" style="color:var(--text-secondary);text-decoration:none">Global Settings</a>
    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="color:var(--text-muted)"><path d="M9 18l6-6-6-6"/></svg>
    <span>Edit</span>
@endsection
...
<div style="display:grid;grid-template-columns:1fr 320px;gap:1.25rem;align-items:start;">
    <div class="card">
        <div class="card-header">
            <div>
                <div class="card-title">Edit Global Settings</div>
                <div class="card-subtitle">Update platform identity and enable/disable platform features</div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('super_admin.platform.global-settings.update') }}" style="padding:20px;">
            ...
            <div style="display:flex;justify-content:flex-end;gap:8px;margin-top:20px;">
                <a href="{{ route('super_admin.platform.global-settings') }}" class="btn btn-outline">Cancel</a>
