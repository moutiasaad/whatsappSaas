...
class ConversationWebController extends Controller
{
    ...
    private function chatI18n(): array
    {
        $keys = [
            ...
            'close_modal_title', 'close_modal_intro', 'close_modal_title_label',
            'close_modal_title_placeholder', 'close_modal_generating',
            'close_modal_regenerate', 'close_modal_close_btn', 'close_modal_cancel',
            'close_modal_generate_failed',
            'claim_success', 'claim_error', 'close_success', 'close_error',
            'reopen_success', 'reopen_error', 'release_success', 'release_error',
