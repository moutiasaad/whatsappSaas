...
class AiSettingsController extends Controller
{
    public function index()
    {
        ...
        // Seed monthly_message_quota from the tenant's plan. If the plan has no
        // ai_message_quota set (null), the tenant inherits null = unlimited.
        // 0 on the plan flows through as 0 = AI off.
        $planQuota = $tenant->plan?->ai_message_quota;
        $settings = $tenant->aiSettings()->firstOrCreate(
            ...
            [
                ...
                'monthly_message_quota'  => $planQuota,
    ...
    public function update(Request $request)
    {
        ...
        // CALC-011) and monthly_message_quota (from the plan — unified sync)
        ...
        $settings->update([
            ...
            // monthly_message_quota is deliberately not writable here. The AI
            // message allowance belongs to the plan — the super admin sets it
            // on the plan and updatePlan() pushes it down — so a tenant POSTing
            // the field must not be able to raise their own cap. The page shows
