...
(function () {
    ...
    function injectStyles() {
        ...
        var css = [
            ...
            "#wvch-root .wvch-feedback { display: inline-flex; gap: 16px; margin: 10px 0 22px; }",
            "#wvch-root .wvch-feedback-btn {",
            "  position: relative; width: 56px; height: 56px; border-radius: 50%;",
            "  background: #f1f5f9; color: var(--wvch-text-2);",
            "  border: 2px solid transparent; cursor: pointer;",
            "  display: inline-flex; align-items: center; justify-content: center;",
            "  transition: background .18s ease, transform .18s ease, color .18s ease, border-color .18s ease, box-shadow .18s ease;",
            "}",
            "#wvch-root .wvch-feedback-btn svg { pointer-events: none; }",
            "#wvch-root .wvch-feedback-btn:hover { background: #e2e8f0; color: var(--wvch-text); transform: translateY(-1px); }",
            "#wvch-root .wvch-feedback-btn:active { transform: scale(.94); }",
            "#wvch-root .wvch-feedback-btn-active {",
            "  background: var(--wvch-accent); color: #fff;",
            "  border-color: var(--wvch-accent);",
            "  box-shadow: 0 8px 20px -8px rgba(46,91,255,.55);",
            "  transform: translateY(-1px) scale(1.05);",
            "}",
            "#wvch-root .wvch-feedback-btn-active:hover { background: var(--wvch-accent-2); color: #fff; }",
            "#wvch-root .wvch-feedback-btn-active::after {",
            "  content: ''; position: absolute; top: -2px; right: -2px;",
            "  width: 16px; height: 16px; border-radius: 50%;",
            "  background: #fff url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%232E5BFF' stroke-width='3.5' stroke-linecap='round' stroke-linejoin='round'><path d='M4 12l5 5L20 6'/></svg>\") center/10px 10px no-repeat;",
            "  box-shadow: 0 2px 6px rgba(0,0,0,.15);",
            "}",
            "#wvch-root[dir='rtl'] .wvch-feedback-btn-active::after { right: auto; left: -2px; }",
